            ...
            <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
              <div className="bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                <Player
                  autoplay
                  loop
                  src={animationJSON}></Player>
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                    <h3 className="text-base font-semibold leading-6 text-gray-900" id="modal-title">Welcome!</h3>
                    <div className="mt-2">
                      <p className="text-sm text-gray-500">We are so glad that you here to try out the Lottie Viewer. First, share with us your name to proceed.</p>                      
                      <div className="mt-2">
