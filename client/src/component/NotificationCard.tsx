...
export const NotificationCard = () => {
  ...
  return createPortal(
    ...
    >
      <div
        className={clsx("px-4 py-3 rounded relative z-50", severityClass)}
        role={notification?.severity}
      >
        <div className="block text-base">{notification?.message}</div>
        ...
        <button
          className="absolute top-0 bottom-0 right-0 px-2 py-2 h-10 w-10"
          onClick={onClose}
        >
          <svg
