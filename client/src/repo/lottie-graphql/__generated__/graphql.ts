...
export type Query = {
  ...
  isUserSelfDeleteAvailable: Scalars['Boolean']['output'];
...
export type Service = {
  ...
  name: Scalars['String']['output'];
  version: Scalars['String']['output'];
  versionInGateway: Scalars['String']['output'];
};
...
export type Mutation = {
  ...
  suggestedWorkspaceJoin?: Maybe<Workspace>;
...
export type MutationEnterpriseLoginArgs = {
  ...
  sourceBusinessUnit?: InputMaybe<Scalars['String']['input']>;
